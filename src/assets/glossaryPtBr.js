export const glossaryPtBr = {
  ...
  compreender:["entender","interpretar"],
  ...
  diferente:["distinto","diverso"], diferenciada:["diversificada","específica"], diferenciadas:["diversificadas","específicas"],
  ...
  criar:["elaborar","construir"], cria:["elabora","constrói"], criam:["elaboram","constroem"], criação:["elaboração","construção"],
